...
<div class="ba-toolbar">
    ...
    <div class="ba-toolbar-group">
        <div class="ba-toolbar-element">
            <input type="text" value="<?php echo $this->item->title; ?>" class="ba-toolbar-label ba-form-title" placeholder="<?php echo JText::_('ENTER_FORM_TITLE'); ?>">
    ...
    <div class="modal-body">
        ...
        <div class="integration-options" data-group="google_drive">
            <div class="ba-settings-group">
                <div class="ba-settings-item ba-settings-button-type">
                    ...
                    <a href="<?php echo $this->driveAuthentication; ?>" target="_blank" class="default-action"><?php echo JText::_('AUTHENTICATE_GOOGLE_ACCOUNT'); ?></a>
                </div>
                <div class="ba-settings-item ba-settings-input-type">
        ...
        <div class="integration-options" data-group="google_sheets">
            <div class="ba-settings-group">
                <div class="ba-settings-item ba-settings-button-type">
                    <span class="ba-settings-item-title"><?php echo JText::_('AUTHENTICATE'); ?></span>
                    <a href="<?php echo $this->sheetsAuthentication; ?>" target="_blank" class="default-action"><?php echo JText::_('AUTHENTICATE_GOOGLE_ACCOUNT'); ?></a>
                </div>
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title"><?php echo JText::_('AUTHENTICATION_CODE'); ?></span>
        ...
        <div class="integration-options" data-group="flutterwave">
            <div class="ba-settings-group">
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">API Key</span>
                    <input type="text" data-key="api_key">
                ...
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Encryption Key</span>
                    <input type="text" data-key="encryption">
                </div>
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Success URL</span>
                    <input type="text" data-key="success_url">
                </div>
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Failure URL</span>
                    <input type="text" data-key="failure_url">
                </div>
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Environment</span>
                    <select data-key="environment">
                        <option value="" hidden></option>
                        <option value="https://api.ravepay.co">Production</option>
                        <option value="https://ravesandboxapi.flutterwave.com">Sandbox</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="integration-options" data-group="zoho_crm">
            <div class="ba-settings-group">
                ...
                <div class="ba-settings-item ba-settings-input-type">
                    ...
                    ?>
                    <input type="text" disabled onfocus="this.blur()" value="<?php echo $zohoRedirect; ?>" class="select-input field-id-input zoho-redirect-uri">
                ...
                <div class="ba-settings-item ba-settings-input-type">
                    ...
                    ?>
                    <input type="text" disabled onfocus="this.blur()" value="<?php echo $zohoScope; ?>" class="select-input field-id-input zoho-redirect-uri">
                    <div class="copy-to-clipboard input-action-icon">
                        <i class="zmdi zmdi-copy"></i>
                        <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('COPY_TO_CLIPBOARD'); ?></span>
                    </div>
                ...
                <div class="tab-content">
                                ...
                                <div class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        <div class="ba-settings-item ba-settings-color-type">
                                            ...
                                            <input type="text" data-type="color" data-group="form" data-subgroup="background" data-option="color">
                                ...
                                <div class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        ...
                                        <div class="ba-settings-item ba-settings-color-type">
                                            ...
                                            <input type="text" data-type="color" data-group="form" data-subgroup="border" data-option="color">
                                            <span class="minicolors-opacity-wrapper">
                                                <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                            </span>
                                ...
                                <div class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        ...
                                        <div class="ba-settings-item ba-settings-color-type">
                                            ...
                                            <input type="text" data-type="color" data-group="form" data-subgroup="shadow" data-option="color">
                                            <span class="minicolors-opacity-wrapper">
                                                <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                            </span>
                    ...
                    <div id="advanced-label-settings" class="row-fluid tab-pane">
                        ...
                        <div class="ba-settings-item ba-settings-typography-toolbar-type">
                            <div class="ba-settings-toolbar">
                                <div>
                                    <label data-option="font-weight" data-value="bold" data-default="normal" data-group="label" data-subgroup="typography" data-option="font-weight">
                                        <i class="zmdi zmdi-format-bold"></i>
                                        <span class="ba-tooltip ba-top ba-hide-element">
                                            <?php echo JText::_('BOLD'); ?>
                                        </span>
                                    </label>
                                    <label data-option="text-transform" data-value="uppercase" data-default="none" data-group="label" data-subgroup="typography" data-option="text-transform">
                                        <i class="zmdi zmdi-format-size"></i>
                                        <span class="ba-tooltip ba-top ba-hide-element">
                                            <?php echo JText::_('UPPERCASE'); ?>
                                        </span>
                                    </label>
                                    <label data-option="font-style" data-value="italic" data-default="normal" data-group="label" data-subgroup="typography" data-option="font-style">
                                ...
                                <div class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        <div class="ba-settings-item ba-settings-color-type">
                                            ...
                                            <input type="text" data-type="color" data-group="field" data-subgroup="background" data-option="color">
                                            <span class="minicolors-opacity-wrapper">
                                                <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                            </span>
                                ...
                                <div class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        ...
                                        <div class="ba-settings-item ba-settings-color-type">
                                            ...
                                            <input type="text" data-type="color" data-group="field" data-subgroup="border" data-option="color">
                                            <span class="minicolors-opacity-wrapper">
                                                <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                            </span>
                                    ...
                                    <div class="accordion-inner">
                                        ...
                                        <div class="ba-settings-item ba-settings-range-type">
                                            ...
                                            <div class="ba-range-wrapper">
                                                ...
                                                <select class="ba-units-select" data-group="field" data-subgroup="units" data-option="font-size">
                                                    <option value="px">px</option>
                                                    <option value="em">em</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="ba-settings-item ba-settings-range-type">
                                            ...
                                            <div class="ba-range-wrapper">
                                                <span class="ba-range-liner letter-spacing"></span>
                                                <input type="range" class="ba-range" min="-10" max="10">
                                                <input type="number" data-group="field" data-subgroup="typography" data-option="letter-spacing">
                                                <select class="ba-units-select" data-group="field" data-subgroup="units" data-option="letter-spacing">
                                                    <option value="px">px</option>
                                                    <option value="em">em</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="ba-settings-item ba-settings-range-type">
                                            ...
                                            <div class="ba-range-wrapper">
                                                <span class="ba-range-liner"></span>
                                                <input type="range" class="ba-range" min="0" max="200">
                                                <input type="number" data-group="field" data-subgroup="typography" data-option="line-height">
                                                <select class="ba-units-select" data-group="field" data-subgroup="units" data-option="line-height">
                                                    <option value="px">px</option>
                                                    <option value="em">em</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="ba-settings-item ba-settings-color-type">
                                            ...
                                            <input type="text" data-type="color" data-group="field" data-subgroup="typography" data-option="color">
                                            <span class="minicolors-opacity-wrapper">
                                                <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                            </span>
                                        ...
                                        <div class="ba-settings-item ba-settings-typography-toolbar-type">
                                            <div class="ba-settings-toolbar">
                                                <div>
                                                    <label data-option="font-weight" data-value="bold" data-default="normal" data-group="field" data-subgroup="typography" data-option="font-weight">
                                                        <i class="zmdi zmdi-format-bold"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('BOLD'); ?>
                                                        </span>
                                                    </label>
                                                    <label data-option="text-transform" data-value="uppercase" data-default="none" data-group="field" data-subgroup="typography" data-option="text-transform">
                                                        <i class="zmdi zmdi-format-size"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('UPPERCASE'); ?>
                                                        </span>
                                                    </label>
                                                    <label data-option="font-style" data-value="italic" data-default="normal" data-group="field" data-subgroup="typography" data-option="font-style">
                                                        <i class="zmdi zmdi-format-italic"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('ITALIC'); ?>
                                                        </span>
                                                ...
                                                <div>
                                                    <label data-value="left" data-group="field" data-subgroup="typography" data-option="text-align">
                                                        <i class="zmdi zmdi-format-align-left"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('LEFT'); ?>
                                                        </span>
                                                    </label>
                                                    <label data-value="center" data-group="field" data-subgroup="typography" data-option="text-align">
                                                        <i class="zmdi zmdi-format-align-center"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('CENTER'); ?>
                                                        </span>
                                                    </label>
                                                    <label data-value="right" data-group="field" data-subgroup="typography" data-option="text-align">
                                                        <i class="zmdi zmdi-format-align-right"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('RIGHT'); ?>
                                                        </span>
                                    ...
                                    <div class="accordion-inner">
                                        <div class="ba-settings-item ba-settings-range-type">
                                            ...
                                            <div class="ba-range-wrapper">
                                                ...
                                                <select class="ba-units-select" data-group="field" data-subgroup="units" data-option="size">
                                                    <option value="px">px</option>
                                                    <option value="em">em</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="ba-settings-item ba-settings-typography-toolbar-type">
                                            <div class="ba-settings-toolbar">
                                                <div>
                                                    <label data-value="flex-start" data-group="field" data-subgroup="icon" data-option="text-align">
                                                        <i class="zmdi zmdi-format-align-left"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('LEFT'); ?>
                                                        </span>
                                                    </label>
                                                    <label data-value="flex-end" data-group="field" data-subgroup="icon" data-option="text-align">
                                                        <i class="zmdi zmdi-format-align-right"></i>
                                                        <span class="ba-tooltip ba-top ba-hide-element">
                                                            <?php echo JText::_('RIGHT'); ?>
                                                        </span>
                    ...
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            <div class="ba-settings-item ba-settings-input-type">
                                ...
                                <input type="text" readonly onfocus="this.blur()" class="select-input select-image" data-option="src" data-callback="imageFieldAction">
                    ...
                    <div class="accordion-inner">
                        ...
                        <div class="ba-settings-group">
                            ...
                            <div class="ba-settings-item ba-settings-input-type ba-settings-selected-dates-wrapper">
                                ...
                                <div class="selected-dates-wrapper">
                                    <div class="selected-input-wrapper">
                                        <input type="text" readonly onfocus="this.blur()" class="select-input open-disable-days-dialog" data-callback="setDisableDates">
                            ...
                            <div class="ba-settings-item ba-settings-input-type ba-settings-selected-dates-wrapper">
                                ...
                                <div class="selected-dates-wrapper">
                                    <div class="selected-input-wrapper">
                                        <input type="text" readonly onfocus="this.blur()" class="select-input open-calendar-dialog" data-callback="setDisableDates">
                                        <div class="input-action-icon input-click-trigger">
                                            <i class="zmdi zmdi-calendar-alt"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="ba-settings-item ba-settings-input-type ba-settings-selected-dates-wrapper">
                                ...
                                <div class="selected-dates-wrapper disable-range-dates">
                                    <div class="selected-input-wrapper">
                                        <input type="text" readonly onfocus="this.blur()" class="select-input open-calendar-dialog" data-callback="setDisableDatesRange" data-index="0">
                                        <div class="input-action-icon input-click-trigger">
                                            <i class="zmdi zmdi-calendar-alt"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="selected-input-wrapper">
                                        <input type="text" readonly onfocus="this.blur()" class="select-input open-calendar-dialog" data-callback="setDisableDatesRange" data-index="1">
                                        <div class="input-action-icon input-click-trigger">
                                            <i class="zmdi zmdi-calendar-alt"></i>
                                        </div>
                                    </div>
                    ...
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            ...
                            <div class="ba-settings-item ba-settings-input-type lightbox-trigger-options" data-trigger="">
                                ...
                                <input type="text" disabled onfocus="this.blur()" class="select-input" value="ba-click-lightbox-form-<?php echo $this->item->id; ?>">
                                <div class="copy-to-clipboard input-action-icon">
                                    <i class="zmdi zmdi-copy"></i>
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('COPY_TO_CLIPBOARD'); ?></span>
                                </div>
                    ...
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            <div class="ba-settings-item ba-settings-input-type">
                                ...
                                <input type="text" readonly onfocus="this.blur()" class="select-input select-image" data-option="icon" data-group="marker" data-callback="mapFieldAction">
                            ...
                            <div class="ba-settings-item ba-settings-text-editor-type">
                                <textarea id="marker-description-editor" class="text-editor-textarea" data-option="description" data-group="marker" data-callback="mapFieldAction"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="accordion-inner">
                                    <div class="ba-settings-group">
                                        ...
                                        <div class="ba-settings-item ba-settings-input-type">
                                            ...
                                            <input type="text" readonly onfocus="this.blur()" class="select-input select-icon" data-option="submit-icon" data-callback="submitFieldAction">
                                            <div class="reset input-action-icon">
                                                <i class="zmdi zmdi-close"></i>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('RESET'); ?></span>
                                            </div>
                                ...
                                <div class="accordion-inner">
                                    <div class="ba-settings-group">
                                        <div class="ba-settings-item ba-settings-checkbox-type">
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="notifications" data-option="enable" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div class="ba-settings-item ba-settings-input-type ba-settings-selected-dates-wrapper">
                                            ...
                                            <div class="selected-dates-wrapper">
                                                <div class="selected-input-wrapper">
                                                    <input type="text" class="add-notifications-admin-emails" placeholder="<?php echo JText::_('ADD_EMAIL_PRESS_ENTER') ?>">
                                                </div>
                                        ...
                                        <div class="ba-settings-item ba-settings-input-type">
                                            ...
                                            <input type="text" data-group="notifications" data-option="subject" data-callback="submitFieldAction">
                                        ...
                                        <div class="ba-settings-item ba-settings-text-editor-type">
                                            <textarea id="notification-email-body-editor" class="text-editor-textarea" data-group="notifications" data-option="body" data-callback="submitFieldAction"></textarea>
                                        </div>
                                        <div class="ba-settings-item ba-settings-checkbox-type pdf-attachment-option">
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="notifications" data-option="attach_pdf" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div class="ba-settings-item ba-settings-checkbox-type">
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="notifications" data-option="attach" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-inner">
                                    <div class="ba-settings-group">
                                        <div class="ba-settings-item ba-settings-checkbox-type">
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="reply" data-option="enable" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div class="ba-settings-item ba-settings-input-type">
                                            <span class="ba-settings-item-title"><?php echo JText::_('SUBJECT'); ?></span>
                                            <input type="text" data-group="reply" data-option="subject" data-callback="submitFieldAction">
                                            <div class="select-default-value input-action-icon">
                                                <i class="zmdi zmdi-playlist-plus"></i>
                                                <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('DATA_TAGS'); ?></span>
                                            </div>
                                        ...
                                        <div class="ba-settings-item ba-settings-text-editor-type">
                                            <textarea id="reply-email-body-editor" class="text-editor-textarea" data-group="reply" data-option="body" data-callback="submitFieldAction"></textarea>
                                        </div>
                                        <div class="ba-settings-item ba-settings-checkbox-type pdf-attachment-option">
                                            <span class="ba-settings-item-title">
                                                <?php echo JText::_('PDF_ATTACHMENT') ?>
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="reply" data-option="attach_pdf" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div class="ba-settings-item ba-settings-checkbox-type">
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="reply" data-option="attach" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="background" data-option="color" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    </div>
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="background" data-option="hover" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                            ...
                            <div class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <div class="ba-settings-item ba-settings-padding-type">
                                        ...
                                        <i class="zmdi zmdi-link spacing-link" data-group="padding" data-callback="submitFieldAction"></i>
                                        <div class="ba-settings-toolbar">
                                            <div>
                                                <span>
                                                    <?php echo JText::_('TOP'); ?>
                                                </span>
                                                <input type="number" data-group="padding" data-option="top" data-callback="submitFieldAction">
                                            </div>
                                            <div>
                                                <span>
                                                    <?php echo JText::_('RIGHT'); ?>
                                                </span>
                                                <input type="number" data-group="padding" data-option="right" data-callback="submitFieldAction">
                                            </div>
                                            <div>
                                                <span>
                                                    <?php echo JText::_('BOTTOM'); ?>
                                                </span>
                                                <input type="number" data-group="padding" data-option="bottom" data-callback="submitFieldAction">
                                            </div>
                                            <div>
                                                <span>
                                                    <?php echo JText::_('LEFT'); ?>
                                                </span>
                                                <input type="number" data-group="padding" data-option="left" data-callback="submitFieldAction">
                                            </div>
                                            <span class="ba-units-value">px</span>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-inner">
                                    <div class="ba-settings-item ba-inline-checkbox">
                                        <div>
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="border" data-option="top" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div>
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="border" data-option="right" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div>
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="border" data-option="bottom" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                        <div>
                                            ...
                                            <label class="ba-form-toggle">
                                                <input type="checkbox" data-group="border" data-option="left" data-callback="submitFieldAction">
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="ba-settings-item ba-settings-range-type">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner"></span>
                                            <input type="range" class="ba-range" min="0" max="100">
                                            <input type="number" data-group="border" data-option="radius" data-callback="submitFieldAction">
                                            <span class="ba-units-value">px</span>
                                        </div>
                                    </div>
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="border" data-option="color" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="border" data-option="hover" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-range-type">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner"></span>
                                            <input type="range" class="ba-range" min="0" max="100">
                                            <input type="number" data-group="border" data-option="width" data-callback="submitFieldAction">
                                            <span class="ba-units-value">px</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-body collapse">
                                <div class="accordion-inner">
                                    <div class="ba-settings-item ba-settings-font-type">
                                        ...
                                        <div class="trigger-picker-modal fonts-select" data-modal="google-fonts-dialog">
                                            <input placeholder="<?php echo JText::_('FONT'); ?>" type="text" readonly onfocus="this.blur()">
                                            <input type="hidden" data-group="typography" data-option="font-family" data-callback="submitFieldAction">
                                        </div>
                                    </div>
                                    <div class="ba-settings-item ba-settings-range-type">
                                        <span class="ba-settings-item-title">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner"></span>
                                            <input type="range" class="ba-range" min="0" max="100">
                                            <input type="number" data-group="typography" data-option="font-size" data-callback="submitFieldAction">
                                            <select class="ba-units-select" data-group="units" data-option="font-size" data-callback="submitFieldAction">
                                                <option value="px">px</option>
                                                <option value="em">em</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="ba-settings-item ba-settings-range-type">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner letter-spacing"></span>
                                            <input type="range" class="ba-range" min="-10" max="10">
                                            <input type="number" data-group="typography" data-option="letter-spacing" data-callback="submitFieldAction">
                                            <select class="ba-units-select" data-group="units" data-option="letter-spacing" data-callback="submitFieldAction">
                                                <option value="px">px</option>
                                                <option value="em">em</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="ba-settings-item ba-settings-range-type">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner"></span>
                                            <input type="range" class="ba-range" min="0" max="200">
                                            <input type="number" data-group="typography" data-option="line-height" data-callback="submitFieldAction">
                                            <select class="ba-units-select" data-group="units" data-option="line-height" data-callback="submitFieldAction">
                                                <option value="px">px</option>
                                                <option value="em">em</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="typography" data-option="color" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="typography" data-option="hover" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-typography-toolbar-type">
                                        <div class="ba-settings-toolbar">
                                            <div>
                                                <label data-option="font-weight" data-value="bold" data-default="normal" data-group="typography" data-option="font-weight" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-bold"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('BOLD'); ?>
                                                    </span>
                                                </label>
                                                <label data-option="text-transform" data-value="uppercase" data-default="none" data-group="typography" data-option="text-transform" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-size"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('UPPERCASE'); ?>
                                                    </span>
                                                </label>
                                                <label data-option="font-style" data-value="italic" data-default="normal" data-group="typography" data-option="font-style" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-italic"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('ITALIC'); ?>
                                                    </span>
                                            ...
                                            <div>
                                                <label data-value="flex-start" data-group="typography" data-option="text-align" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-align-left"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('LEFT'); ?>
                                                    </span>
                                                </label>
                                                <label data-value="center" data-group="typography" data-option="text-align" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-align-center"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('CENTER'); ?>
                                                    </span>
                                                </label>
                                                <label data-value="flex-end" data-group="typography" data-option="text-align" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-align-right"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('RIGHT'); ?>
                                                    </span>
                                                </label>
                                                <label data-value="1" data-group="typography" data-option="text-align" data-callback="submitFieldAction">
                                ...
                                <div class="accordion-inner">
                                    <div class="ba-settings-item ba-settings-range-type">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner"></span>
                                            <input type="range" class="ba-range" min="0" max="6">
                                            <input type="number" data-group="shadow" data-option="value" data-callback="submitFieldAction">
                                        </div>
                                    </div>
                                    <div class="ba-settings-item ba-settings-color-type">
                                        <span class="ba-settings-item-title">
                                        ...
                                        <input type="text" data-type="color" data-group="shadow" data-option="color" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="shadow" data-option="hover" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                ...
                                <div class="accordion-inner">
                                    <div class="ba-settings-item ba-settings-range-type">
                                        ...
                                        <div class="ba-range-wrapper">
                                            <span class="ba-range-liner"></span>
                                            <input type="range" class="ba-range" min="0" max="100">
                                            <input type="number" data-group="icon" data-option="size" data-callback="submitFieldAction">
                                            <select class="ba-units-select" data-group="units" data-option="size" data-callback="submitFieldAction">
                                                <option value="px">px</option>
                                                <option value="em">em</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="icon" data-option="color" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-color-type">
                                        ...
                                        <input type="text" data-type="color" data-group="icon" data-option="hover" data-callback="submitFieldAction">
                                        <span class="minicolors-opacity-wrapper">
                                            <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="submitFieldAction">
                                            <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                        </span>
                                    ...
                                    <div class="ba-settings-item ba-settings-typography-toolbar-type">
                                        <div class="ba-settings-toolbar">
                                            <div>
                                                <label data-value="row" data-group="icon" data-option="text-align" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-align-left"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('LEFT'); ?>
                                                    </span>
                                                </label>
                                                <label data-value="row-reverse" data-group="icon" data-option="text-align" data-callback="submitFieldAction">
                                                    <i class="zmdi zmdi-format-align-right"></i>
                                                    <span class="ba-tooltip ba-top ba-hide-element">
                                                        <?php echo JText::_('RIGHT'); ?>
                                                    </span>
                    ...
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            <div class="ba-settings-item ba-settings-text-editor-type dialog-options">
                                <textarea id="acceptance-editor" class="text-editor-textarea" data-option="html" data-callback="acceptanceFieldAction"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            <div class="ba-settings-item ba-settings-font-type">
                                ...
                                <div class="trigger-picker-modal fonts-select" data-modal="google-fonts-dialog">
                                    <input placeholder="<?php echo JText::_('FONT'); ?>" type="text" readonly onfocus="this.blur()">
                                    <input type="hidden" data-group="label" data-subgroup="typography" data-option="font-family" data-callback="headlineAction">
                                </div>
                            </div>
                            <div class="ba-settings-item ba-settings-range-type">
                                <span class="ba-settings-item-title">
                                ...
                                <div class="ba-range-wrapper">
                                    <span class="ba-range-liner"></span>
                                    <input type="range" class="ba-range" min="0" max="100">
                                    <input type="number" data-group="label" data-subgroup="typography" data-option="font-size" data-callback="headlineAction">
                                    <select class="ba-units-select" data-group="label" data-subgroup="units" data-option="font-size" data-callback="headlineAction">
                                        <option value="px">px</option>
                                        <option value="em">em</option>
                                    </select>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-range-type">
                                ...
                                <div class="ba-range-wrapper">
                                    <span class="ba-range-liner letter-spacing"></span>
                                    <input type="range" class="ba-range" min="-10" max="10">
                                    <input type="number" data-group="label" data-subgroup="typography" data-option="letter-spacing" data-callback="headlineAction">
                                    <select class="ba-units-select" data-group="label" data-subgroup="units" data-option="letter-spacing" data-callback="headlineAction">
                                        <option value="px">px</option>
                                        <option value="em">em</option>
                                    </select>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-range-type">
                                ...
                                <div class="ba-range-wrapper">
                                    <span class="ba-range-liner"></span>
                                    <input type="range" class="ba-range" min="0" max="200">
                                    <input type="number" data-group="label" data-subgroup="typography" data-option="line-height" data-callback="headlineAction">
                                    <select class="ba-units-select" data-group="label" data-subgroup="units" data-option="line-height" data-callback="headlineAction">
                                        <option value="px">px</option>
                                        <option value="em">em</option>
                                    </select>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-color-type">
                                ...
                                <input type="text" data-type="color" data-group="label" data-subgroup="typography" data-option="color" data-callback="headlineAction">
                                <span class="minicolors-opacity-wrapper">
                                    <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                </span>
                            ...
                            <div class="ba-settings-item ba-settings-typography-toolbar-type">
                                <div class="ba-settings-toolbar">
                                    <div>
                                        <label data-option="font-weight" data-value="bold" data-default="normal" data-group="label" data-subgroup="typography" data-option="font-weight" data-callback="headlineAction">
                                            <i class="zmdi zmdi-format-bold"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('BOLD'); ?>
                                            </span>
                                        </label>
                                        <label data-option="text-transform" data-value="uppercase" data-default="none" data-group="label" data-subgroup="typography" data-option="text-transform" data-callback="headlineAction">
                                            <i class="zmdi zmdi-format-size"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('UPPERCASE'); ?>
                                            </span>
                                        </label>
                                        <label data-option="font-style" data-value="italic" data-default="normal" data-group="label" data-subgroup="typography" data-option="font-style" data-callback="headlineAction">
                                            <i class="zmdi zmdi-format-italic"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('ITALIC'); ?>
                                            </span>
                                    ...
                                    <div>
                                        <label data-value="left" data-group="label" data-subgroup="typography" data-option="text-align" data-callback="headlineAction">
                                            <i class="zmdi zmdi-format-align-left"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('LEFT'); ?>
                                            </span>
                                        </label>
                                        <label data-value="center" data-group="label" data-subgroup="typography" data-option="text-align" data-callback="headlineAction">
                                            <i class="zmdi zmdi-format-align-center"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('CENTER'); ?>
                                            </span>
                                        </label>
                                        <label data-value="right" data-group="label" data-subgroup="typography" data-option="text-align" data-callback="headlineAction">
                                            <i class="zmdi zmdi-format-align-right"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('RIGHT'); ?>
                                            </span>
                    ...
                    <div class="accordion-inner">
                        <div class="ba-form-calculator">
                            <div class="ba-form-calculator-header">
                                <textarea class="ba-form-calculator-screen" data-option="formula" data-callback="inputFieldAction"></textarea>
                            </div>
                    ...
                    <div class="accordion-inner">
                        ...
                        <div class="ba-settings-group field-design-options">
                            ...
                            <div class="ba-settings-item ba-settings-font-type">
                                ...
                                <div class="trigger-picker-modal fonts-select" data-modal="google-fonts-dialog">
                                    <input placeholder="<?php echo JText::_('FONT'); ?>" type="text" readonly onfocus="this.blur()">
                                    <input type="hidden" data-group="label" data-subgroup="typography" data-option="font-family" data-callback="calculationAction">
                                </div>
                            </div>
                            <div class="ba-settings-item ba-settings-range-type">
                                <span class="ba-settings-item-title">
                                ...
                                <div class="ba-range-wrapper">
                                    <span class="ba-range-liner"></span>
                                    <input type="range" class="ba-range" min="0" max="100">
                                    <input type="number" data-group="label" data-subgroup="typography" data-option="font-size" data-callback="calculationAction">
                                    <select class="ba-units-select" data-group="label" data-subgroup="units" data-option="font-size" data-callback="calculationAction">
                                        <option value="px">px</option>
                                        <option value="em">em</option>
                                    </select>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-range-type">
                                ...
                                <div class="ba-range-wrapper">
                                    <span class="ba-range-liner letter-spacing"></span>
                                    <input type="range" class="ba-range" min="-10" max="10">
                                    <input type="number" data-group="label" data-subgroup="typography" data-option="letter-spacing" data-callback="calculationAction">
                                    <select class="ba-units-select" data-group="label" data-subgroup="units" data-option="letter-spacing" data-callback="calculationAction">
                                        <option value="px">px</option>
                                        <option value="em">em</option>
                                    </select>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-range-type">
                                ...
                                <div class="ba-range-wrapper">
                                    <span class="ba-range-liner"></span>
                                    <input type="range" class="ba-range" min="0" max="200">
                                    <input type="number" data-group="label" data-subgroup="typography" data-option="line-height" data-callback="calculationAction">
                                    <select class="ba-units-select" data-group="label" data-subgroup="units" data-option="line-height" data-callback="calculationAction">
                                        <option value="px">px</option>
                                        <option value="em">em</option>
                                    </select>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-color-type">
                                ...
                                <input type="text" data-type="color" data-group="label" data-subgroup="typography" data-option="color" data-callback="calculationAction">
                                <span class="minicolors-opacity-wrapper">
                                    <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback>
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                </span>
                            ...
                            <div class="ba-settings-item ba-settings-typography-toolbar-type">
                                <div class="ba-settings-toolbar">
                                    <div>
                                        <label data-option="font-weight" data-value="bold" data-default="normal" data-group="label" data-subgroup="typography" data-option="font-weight" data-callback="calculationAction">
                                            <i class="zmdi zmdi-format-bold"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('BOLD'); ?>
                                            </span>
                                        </label>
                                        <label data-option="text-transform" data-value="uppercase" data-default="none" data-group="label" data-subgroup="typography" data-option="text-transform" data-callback="calculationAction">
                                            <i class="zmdi zmdi-format-size"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('UPPERCASE'); ?>
                                            </span>
                                        </label>
                                        <label data-option="font-style" data-value="italic" data-default="normal" data-group="label" data-subgroup="typography" data-option="font-style" data-callback="calculationAction">
                                            <i class="zmdi zmdi-format-italic"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('ITALIC'); ?>
                                            </span>
                                    ...
                                    <div>
                                        <label data-value="left" data-group="label" data-subgroup="typography" data-option="text-align" data-callback="calculationAction">
                                            <i class="zmdi zmdi-format-align-left"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('LEFT'); ?>
                                            </span>
                                        </label>
                                        <label data-value="center" data-group="label" data-subgroup="typography" data-option="text-align" data-callback="calculationAction">
                                            <i class="zmdi zmdi-format-align-center"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('CENTER'); ?>
                                            </span>
                                        </label>
                                        <label data-value="right" data-group="label" data-subgroup="typography" data-option="text-align" data-callback="calculationAction">
                                            <i class="zmdi zmdi-format-align-right"></i>
                                            <span class="ba-tooltip ba-top ba-hide-element">
                                                <?php echo JText::_('RIGHT'); ?>
                                            </span>
                        ...
                        <div class="ba-settings-group field-design-options">
                            <div class="ba-settings-item ba-settings-color-type">
                                ...
                                <input type="text" data-type="color" data-group="background" data-option="color" data-callback="calculationAction">
                                <span class="minicolors-opacity-wrapper">
                                    <input type="number" class="minicolors-opacity" min="0" max="1" step="0.01" data-callback="calculationAction">
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('OPACITY') ?></span>
                                </span>
                            </div>
                        </div>
                        <div class="ba-settings-group field-design-options">
                            <div class="ba-settings-item ba-settings-padding-type">
                                ...
                                <i class="zmdi zmdi-link spacing-link" data-group="padding" data-callback="calculationAction"></i>
                                <div class="ba-settings-toolbar">
                                    <div>
                                        <span>
                                            <?php echo JText::_('TOP'); ?>
                                        </span>
                                        <input type="number" data-group="padding" data-option="top" data-callback="calculationAction">
                                    </div>
                                    <div>
                                        <span>
                                            <?php echo JText::_('RIGHT'); ?>
                                        </span>
                                        <input type="number" data-group="padding" data-option="right" data-callback="calculationAction">
                                    </div>
                                    <div>
                                        <span>
                                            <?php echo JText::_('BOTTOM'); ?>
                                        </span>
                                        <input type="number" data-group="padding" data-option="bottom" data-callback="calculationAction">
                                    </div>
                                    <div>
                                        <span>
                                            <?php echo JText::_('LEFT'); ?>
                                        </span>
                                        <input type="number" data-group="padding" data-option="left" data-callback="calculationAction">
                                    </div>
                                    <span class="ba-units-value">px</span>
                                </div>
                            </div>
                        ...
                        <div class="ba-settings-group">
                            ...
                            <div class="promo-code-options">
                                ...
                                <div class="ba-settings-item ba-settings-input-type">
                                    ...
                                    <input type="text" data-group="promo" data-option="expires" readonly onfocus="this.blur()" class="select-input open-calendar-dialog" data-callback="setCartExpire">
                                    <div class="reset input-action-icon">
                                        <i class="zmdi zmdi-close"></i>
                                        <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('RESET'); ?></span>
                                    </div>
                ...
                <div class="accordion-body in collapse">
                    <div class="accordion-inner">
                        ...
                        <div class="ba-settings-group">
                            ...
                            <div class="ba-settings-item ba-settings-input-type">
                                <span class="ba-settings-item-title"><?php echo JText::_('ICON'); ?></span>
                                <input type="text" readonly onfocus="this.blur()" class="select-input select-icon" data-option="icon" data-callback="inputFieldAction">
                                <div class="reset input-action-icon">
                                    <i class="zmdi zmdi-close"></i>
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('RESET'); ?></span>
                                </div>
                ...
                <div class="accordion-body collapse">
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            ...
                            <div class="ba-settings-item ba-settings-input-type email-type-options email-confirm-options">
                                <span class="ba-settings-item-title"><?php echo JText::_('ICON'); ?></span>
                                <input type="text" readonly onfocus="this.blur()" class="select-input select-icon" data-group="confirm" data-option="icon" data-callback="inputFieldAction">
                                <div class="reset input-action-icon">
                                    <i class="zmdi zmdi-close"></i>
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('RESET'); ?></span>
                                </div>
                            ...
                            <div class="ba-settings-item ba-settings-input-type password-type-options password-confirm-options">
                                <span class="ba-settings-item-title"><?php echo JText::_('ICON'); ?></span>
                                <input type="text" readonly onfocus="this.blur()" class="select-input select-icon" data-group="confirm-password" data-option="icon" data-callback="inputFieldAction">
                                <div class="reset input-action-icon">
                                    <i class="zmdi zmdi-close"></i>
                                    <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('RESET'); ?></span>
                                </div>
        ...
        <div class="ba-work-area">
            <div class="ba-integrations-group-wrapper">
                <div class="integrations-group">
                    ...
                    ?>
                        <div class="templates-element ba-work-area-element" data-group="<?php echo $formTemplate->group; ?>" data-key="<?php echo $formTemplate->key; ?>" data-id="<?php echo $formTemplate->id; ?>">
                            <div class="templates-element-image" style="background-image: url(<?php echo $formTemplateImg; ?>);"></div>
        ...
        <div class="ba-work-area">
            ...
            <div class="ba-integrations-group-wrapper">
                <div class="integrations-group">
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('campaign_monitor'); ?>" data-group="emailling" data-type="campaign_monitor">
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('google_drive'); ?>" data-group="data-storage" data-type="google_drive">
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('google_sheets'); ?>" data-group="data-storage" data-type="google_sheets">
                    ...
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="payupl">
                        <img src="<?php echo JUri::root() . 'administrator/components/com_baforms/assets/images/payupl.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>PayU Polska</span>
                    </div>
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('pdf_submissions'); ?>" data-group="data-storage" data-type="pdf_submissions">
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('zoho_crm'); ?>" data-group="data-storage" data-type="zoho_crm">
                        <img src="<?php echo JUri::root() . 'administrator/components/com_baforms/assets/images/zoho.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Zoho CRM</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="flutterwave">
                        <img src="<?php echo JUri::root() . 'administrator/components/com_baforms/assets/images/flutterwave.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
...
<div id="library-placeholder" style="display: none;">
    <div></div>
</div>
